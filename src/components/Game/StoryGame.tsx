...
function ParallaxWorld({ bg, worldX, gateOpen, gateFrame, landmarkAnchor, nearby, boulderState, landmarkKind, appleTreeAnchor, trunkAnchor, computerOn, logsVisible }: { bg: SceneBg; worldX: number; gateOpen: boolean; gateFrame: number; landmarkAnchor: number | null; nearby: boolean; boulderState: BoulderState; landmarkKind: 'gate' | 'estufa-ext' | 'trunk' | 'computer'; appleTreeAnchor: number | null; trunkAnchor: number | null; computerOn: boolean; logsVisible: boolean }) {
  ...
  if (bg === 'pantano') {
    return (
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: FLOOR, overflow: 'hidden' }}>
        ...
        {/* camada_3 — back-silh */}
        <div style={layer('/assets/pantano/back-silh.png', 0.18, 2, { backgroundSize: 'auto 350px', backgroundPositionY: 'bottom' })} />
        ...
        <div style={{ position: 'absolute', bottom: GROUND + 70, zIndex: 3, left: 0, pointerEvents: 'none',
          ...
          <img src="/assets/pantano/croc.png" alt="" style={{ height: 61, width: 'auto', imageRendering: 'pixelated', animation: 'croc-bob 4s ease-in-out infinite' }} />
        </div>
  ...
  if (bg === 'corredor' || bg === 'final') {
    ...
    return (
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: bg === 'corredor' ? 0 : FLOOR, overflow: 'hidden', background: cfg.base }}>
        ...
        {bg === 'corredor' && (
          <div style={{
            ...
            backgroundPositionY: `bottom ${GROUND}px`,
            imageRendering: 'pixelated',
          }} />
        )}
