...
const PACKS: Pack[] = [
  ...
  },
  {
    ...
    badgeColor: '#40e0d0',
    parallax: [
      { src: '/assets/forest/Layer_0011_0.png',   factor: 0.04 },
      { src: '/assets/forest/Layer_0010_1.png',   factor: 0.09 },
      { src: '/assets/forest/Layer_0009_2.png',   factor: 0.15 },
      { src: '/assets/forest/Layer_0008_3.png',   factor: 0.22 },
      { src: '/assets/forest/Layer_0006_4.png',   factor: 0.36 },
      { src: '/assets/forest/Layer_0005_5.png',   factor: 0.46 },
      { src: '/assets/forest/Layer_0003_6.png',   factor: 0.64 },
      { src: '/assets/forest/Layer_0002_7.png',   factor: 0.76 },
      { src: '/assets/forest/Layer_0001_8.png',   factor: 0.90 },
      { src: '/assets/forest/Layer_0000_9.png',   factor: 1.06 },
    ],
    scenes: [
      { id: 'em-l11', thumb: '/assets/forest/Layer_0011_0.png', name: 'Camada 1 — Céu' },
      { id: 'em-l10', thumb: '/assets/forest/Layer_0010_1.png', name: 'Camada 2' },
      { id: 'em-l09', thumb: '/assets/forest/Layer_0009_2.png', name: 'Camada 3' },
      { id: 'em-l08', thumb: '/assets/forest/Layer_0008_3.png', name: 'Camada 4' },
      { id: 'em-l06', thumb: '/assets/forest/Layer_0006_4.png', name: 'Camada 5' },
      { id: 'em-l05', thumb: '/assets/forest/Layer_0005_5.png', name: 'Camada 6' },
      { id: 'em-l03', thumb: '/assets/forest/Layer_0003_6.png', name: 'Camada 7' },
      { id: 'em-l02', thumb: '/assets/forest/Layer_0002_7.png', name: 'Camada 8' },
      { id: 'em-l01', thumb: '/assets/forest/Layer_0001_8.png', name: 'Camada 9' },
      { id: 'em-l00', thumb: '/assets/forest/Layer_0000_9.png', name: 'Camada 10 — Grama (frente)' },
    ],
  },
  {
    ...
    badgeColor: '#88ff66',
    parallax: [
      { src: '/assets/tallforest/back.png',   factor: 0.06 },
      { src: '/assets/tallforest/far.png',    factor: 0.30 },
      { src: '/assets/tallforest/middle.png', factor: 0.85 },
    ],
    scenes: [
      { id: 'tf2-back',   thumb: '/assets/preview/tallforest-back.png',   name: 'Camada 1 — Fundo' },
      { id: 'tf2-far',    thumb: '/assets/preview/tallforest-far.png',    name: 'Camada 2 — Distante' },
      { id: 'tf2-middle', thumb: '/assets/preview/tallforest-middle.png', name: 'Camada 3 — Frente' },
    ],
  },
  {
