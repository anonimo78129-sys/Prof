...
export const MAPAS: Record<string, Mapa> = {
  povoado: {
    ...
    objetos: [
      ...
      { x: 4, y: 0, peca: 'arvore' },
      { x: 8, y: 0, peca: 'arvore' },
      { x: 12, y: 0, peca: 'arvore' },
      { x: 16, y: 0, peca: 'arvore' },
      { x: 20, y: 0, peca: 'arvore' },
      { x: 24, y: 0, peca: 'arvore' },
      { x: 0, y: 29, peca: 'arvore' },
      { x: 4, y: 29, peca: 'arvore' },
      { x: 8, y: 29, peca: 'arvore' },
      { x: 16, y: 29, peca: 'arvore' },
      { x: 20, y: 29, peca: 'arvore' },
      { x: 24, y: 29, peca: 'arvore' },
      { x: 0, y: 5, peca: 'arvore' },
      { x: 26, y: 5, peca: 'arvore' },
      { x: 24, y: 8, peca: 'pinheiro' },
      { x: 0, y: 10, peca: 'arvore' },
      { x: 26, y: 10, peca: 'arvore' },
      { x: 4, y: 12, peca: 'arvoreMedia' },
      { x: 24, y: 13, peca: 'pinheiro' },
      { x: 0, y: 15, peca: 'arvore' },
      { x: 26, y: 15, peca: 'arvore' },
      { x: 4, y: 17, peca: 'arvoreMedia' },
      { x: 24, y: 18, peca: 'pinheiro' },
      { x: 0, y: 20, peca: 'arvore' },
      { x: 26, y: 20, peca: 'arvore' },
      { x: 4, y: 22, peca: 'arvoreMedia' },
      { x: 0, y: 25, peca: 'arvore' },
      { x: 26, y: 25, peca: 'arvore' },
      { x: 24, y: 28, peca: 'pinheiro' },
      { x: 7, y: 6, peca: 'casa' },
      { x: 17, y: 6, peca: 'casa' },
      { x: 7, y: 25, peca: 'casa' },
      { x: 9, y: 16, peca: 'varal' },
      { x: 18, y: 16, peca: 'caixotes' },
      { x: 20, y: 19, peca: 'carroca' },
      { x: 18, y: 27, peca: 'rochedo' },
      { x: 11, y: 10, peca: 'estatua' },
      { x: 7, y: 30, peca: 'altar' },
      { x: 8, y: 17, peca: 'canteiro' },
      { x: 8, y: 20, peca: 'canteiro' },
      { x: 11, y: 17, peca: 'canteiro' },
      { x: 17, y: 24, peca: 'toco' },
      { x: 12, y: 16, peca: 'poste' },
      { x: 17, y: 16, peca: 'poste' },
      { x: 16, y: 20, peca: 'pote' },
      { x: 17, y: 20, peca: 'caixote' },
      { x: 18, y: 20, peca: 'saco' },
      { x: 9, y: 28, peca: 'pote' },
      { x: 20, y: 23, peca: 'pedregulho' },
      { x: 11, y: 28, peca: 'pedra' },
      { x: 21, y: 10, peca: 'cruz' },
      { x: 22, y: 11, peca: 'cruz' },
      { x: 9, y: 30, peca: 'osso' },
      { x: 16, y: 28, peca: 'girassol' },
      { x: 17, y: 29, peca: 'florRosa' },
      { x: 7, y: 16, peca: 'moitaVerde' },
      { x: 20, y: 8, peca: 'arvoreMedia' },
      { x: 8, y: 29, peca: 'moitaVerde' },
      { x: 19, y: 30, peca: 'pinheiro' },
      { x: 12, y: 24, peca: 'vaso' },
      { x: 21, y: 17, peca: 'cogumelo' },
      { x: 10, y: 24, peca: 'pinheiro' },
      { x: 20, y: 14, peca: 'arvoreMedia' },
      { x: 9, y: 12, peca: 'moitaVerde' },
    ],
    npcs: [
      { id: 'nita', x: 13, y: 19, arte: 'p12', olhando: 3, encontro: 'poco' },
      { id: 'doril', x: 10, y: 19, arte: 'p2', olhando: 0, encontro: 'horta' },
      { id: 'vilma', x: 17, y: 18, arte: 'p4', olhando: 0, encontro: 'paiol' },
      {
        id: 'anciã',
        x: 14,
        y: 10,
    ...
    saidas: [{ x: 14, y: 33, para: 'trilha', destinoX: 14, destinoY: 1 }],
  },
  ...
  trilha: {
    ...
    objetos: [
      ...
      { x: 20, y: 0, peca: 'arvore' },
      { x: 24, y: 0, peca: 'arvore' },
      { x: 0, y: 35, peca: 'arvore' },
      { x: 4, y: 35, peca: 'arvore' },
      { x: 8, y: 35, peca: 'arvore' },
      { x: 12, y: 35, peca: 'arvore' },
      { x: 20, y: 35, peca: 'arvore' },
      { x: 24, y: 35, peca: 'arvore' },
      { x: 0, y: 5, peca: 'arvore' },
      { x: 26, y: 5, peca: 'arvore' },
      { x: 4, y: 7, peca: 'arvoreMedia' },
      { x: 0, y: 10, peca: 'arvore' },
      { x: 26, y: 10, peca: 'arvore' },
      { x: 0, y: 15, peca: 'arvore' },
      { x: 26, y: 15, peca: 'arvore' },
      ...
      { x: 26, y: 20, peca: 'arvore' },
      { x: 4, y: 22, peca: 'arvoreMedia' },
      { x: 24, y: 23, peca: 'pinheiro' },
      { x: 0, y: 25, peca: 'arvore' },
      { x: 26, y: 25, peca: 'arvore' },
      { x: 0, y: 30, peca: 'arvore' },
      { x: 26, y: 30, peca: 'arvore' },
      { x: 4, y: 32, peca: 'arvoreMedia' },
      { x: 24, y: 33, peca: 'pinheiro' },
      { x: 11, y: 7, peca: 'rochedo' },
      { x: 17, y: 8, peca: 'bosqueMorto' },
      { x: 12, y: 16, peca: 'bosqueMorto' },
      { x: 16, y: 15, peca: 'carroca' },
      { x: 12, y: 9, peca: 'toco' },
      { x: 13, y: 25, peca: 'pedraGrande' },
      { x: 16, y: 27, peca: 'bosqueMorto' },
      { x: 7, y: 32, peca: 'bosqueMorto' },
      { x: 14, y: 30, peca: 'toco' },
      { x: 11, y: 31, peca: 'broto' },
      { x: 13, y: 32, peca: 'broto' },
      { x: 12, y: 33, peca: 'broto' },
      { x: 14, y: 33, peca: 'broto' },
      { x: 10, y: 33, peca: 'broto' },
      { x: 15, y: 34, peca: 'broto' },
      { x: 13, y: 35, peca: 'broto' },
      { x: 11, y: 29, peca: 'girassol' },
      { x: 15, y: 32, peca: 'margarida' },
      { x: 17, y: 34, peca: 'moitaVerde' },
      { x: 8, y: 27, peca: 'arvoreMedia' },
      { x: 16, y: 31, peca: 'cogumelo' },
      { x: 13, y: 20, peca: 'caveira' },
      { x: 12, y: 11, peca: 'osso' },
      { x: 18, y: 12, peca: 'cruz' },
      { x: 11, y: 19, peca: 'pedregulho' },
      { x: 16, y: 20, peca: 'pedra' },
      { x: 13, y: 14, peca: 'florRosa' },
      { x: 22, y: 30, peca: 'caverna' },
      { x: 7, y: 20, peca: 'pinheiro' },
      { x: 20, y: 33, peca: 'arvoreMedia' },
    ],
    npcs: [
      { id: 'teo', x: 13, y: 33, arte: 'p6', olhando: 3, encontro: 'clareira' },
      {
        id: 'andarilho',
        x: 11, y: 17, arte: 'p7', olhando: 3,
        conversa: [
    ...
    saidas: [
      { x: 14, y: 0, para: 'povoado', destinoX: 14, destinoY: 32 },
      { x: 18, y: 39, para: 'estacao', destinoX: 9, destinoY: 14 },
    ],
  },
  ...
  estacao: {
    ...
    npcs: [],
    saidas: [{ x: 9, y: 15, para: 'trilha', destinoX: 18, destinoY: 38 }],
  },
};
