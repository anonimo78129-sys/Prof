...
const beats: Beat[] = [
  ...
  { t: 'say', who: 'corujao', lines: [
    ...
    'Para passar, você precisa provar que entende a natureza. Use o que aprendeu!',
  ] },
  { t: 'battle',
    intro: 'O nó luminoso pulsa, desafiando você. Prove que entende a vida — com FOTOSSÍNTESE, REDE DE FUNGOS, TRANSPIRAÇÃO e ESPORA.',
    success: [
    ...
    hint: 'Ataque com REDE DE FUNGOS, cure com TRANSPIRAÇÃO quando estiver baixo e use ESPORA para enfraquecer o golpe seguinte da floresta.',
  },
  { t: 'say', who: 'estudante', lines: [
